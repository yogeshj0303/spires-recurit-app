                                            ...
                                            return AlertDialog(
                                              ...
                                              content: Column(
                                                ...
                                                children: [
                                                  ...
                                                  const SizedBox(height: 8),
                                                  Text(
                                                    'The payment feature for ${program.title} program (₹${NumberFormat('#,##0').format(price)}) will be available soon. We\'re working hard to bring you a seamless payment experience.',
                                                    style: TextStyle(
                                                      fontSize: 14,
