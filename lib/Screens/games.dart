...
class _QuizScreenState extends State<QuizScreen> {
  ...
  void initState() {
    ...
    // Only fetch questions if not in guest mode
  ...
  Widget build(BuildContext context) {
    ...
    if (c.isGuestMode.value) {
      return GuestRegistrationForm(quizId: widget.quizId);
    }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              const Text(
                'Thank you for registering. We will contact you shortly with further details about the quiz/olympiad.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 16,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Fill in your details to register for this quiz or olympiad',
                              style: TextStyle(
                                fontSize: 14,
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Enter your class or year',
